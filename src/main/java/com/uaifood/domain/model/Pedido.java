...
public class Pedido {
	...
	//CascadeType.ALL -> Para indicar que ao salvar o pedido também é para salvar os itens do pedido
	...
	@PrePersist  //Metodo de callback do jpa, diz pro jpa ,antes de incluir o pedido, executa esse metodo
