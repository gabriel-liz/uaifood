...
public interface RestauranteRepository extends JpaRepository<Restaurante, Long>, RestauranteRepositoryQueries, JpaSpecificationExecutor<Restaurante> {
	...
	// List<Restaurante> queryQualquerCoisaByTaxaFreteBetween(BigDecimal
	// taxaInicial, BigDecimal taxaFinal);

	// @Query("from Restaurante where nome like %:nome% and cozinha.id = :id")
	List<Restaurante> consultarPorNome(String nome, @Param("id") Long cozinhaId);
	// O metodo acima faz as mesmas coisas que o metodo comentado abaixo, porem sem
	// expor o nome dos atributos. Para testar apenas mudar a chamado na classe
	// TesteController
